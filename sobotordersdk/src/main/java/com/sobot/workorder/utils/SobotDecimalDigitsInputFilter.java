...
public class SobotDecimalDigitsInputFilter extends DigitsKeyListener {
    private static final String TAG = "MoneyValueFilter";

    public SobotDecimalDigitsInputFilter() {
        super(false, true);
    }

    private int digits = 2;

    public SobotDecimalDigitsInputFilter setDigits(int d) {
        digits = d;
        return this;
    }
