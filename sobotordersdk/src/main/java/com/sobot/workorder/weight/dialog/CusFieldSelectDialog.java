...
public class CusFieldSelectDialog extends SobotBottomDialog implements View.OnClickListener {
    ...
    public CusFieldSelectDialog(Activity context, String title, List<String> list, int selectIndex, DialogItemOnClick listener){
        super(context);
        activity = context;
    ...
    protected int getLayout() {
        return R.layout.sobot_common_dialog_select;
    }
...
//            e.printStackTrace();
    ...
    class CallCommonAdapter extends RecyclerView.Adapter {
        ...
        public CallCommonAdapter(Context context, List<String> list, DialogItemOnClick listener) {
