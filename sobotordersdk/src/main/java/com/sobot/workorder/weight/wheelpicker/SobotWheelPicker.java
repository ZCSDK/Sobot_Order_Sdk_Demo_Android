 ...
 * @version 1.1.2
 */
public class SobotWheelPicker extends View implements SobotIWheelPicker, Runnable {
    /**
     * 滚动状态标识值
     *
    ...
    private static final String TAG = SobotWheelPicker.class.getSimpleName();
    ...
    public SobotWheelPicker(Context context) {
        this(context, null);
    }

    public SobotWheelPicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mItemTextSize = a.getDimensionPixelSize(R.styleable.WheelPicker_wheel_item_text_size,
                getResources().getDimensionPixelSize(R.dimen.sobot_wheelItemTextSize));
        ...
        mItemSpace = a.getDimensionPixelSize(R.styleable.WheelPicker_wheel_item_space,
                getResources().getDimensionPixelSize(R.dimen.sobot_wheelItemSpace));
        ...
        mIndicatorSize = a.getDimensionPixelSize(R.styleable.WheelPicker_wheel_indicator_size,
                getResources().getDimensionPixelSize(R.dimen.sobot_wheelIndicatorSize));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(mRectCurrentItem);
        mPaint.setColor(getContext().getResources().getColor(R.color.whellpickerl_current_line));
        mPaint.setStrokeWidth((float) 1.0);
        int left = mRectCurrentItem.left;
        int right = mRectCurrentItem.right;
        int top = mRectCurrentItem.top;
        int bottom = mRectCurrentItem.bottom;
        canvas.drawLine(left, top + 1, right, top + 1, mPaint);
        canvas.restore();
...
//    }
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(SobotWheelPicker picker, Object data, int position);
    }
    ...
    public interface OnWheelChangeListener {
         ...
         *              {@link SobotWheelPicker#SCROLL_STATE_IDLE}
         *              表示滚动选择器处于静止状态
         *              {@link SobotWheelPicker#SCROLL_STATE_DRAGGING}
         *              表示滚动选择器处于拖动状态
         *              {@link SobotWheelPicker#SCROLL_STATE_SCROLLING}
         *              表示滚动选择器处于滑动状态
         *              <p>
