package com.sobot.workorder.weight.image;
...
public class SobotGifView extends View implements View.OnTouchListener {
    ...
    public SobotGifView(Context context) {
        this(context, null);
    }

    public SobotGifView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SobotGifView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.SobotGifView, defStyleAttr, android.R.style.Widget);

        movieMovieResourceId = array.getResourceId(R.styleable.SobotGifView_sobot_gif, -1);
        array.recycle();
...
//        super.onMeasure(widthMeasureSpec,heightMeasureSpec);
        if (movie != null) {
            movieMeasuredMovieWidth = SobotDensityUtil.dp2px(getContext(), movie.width());
            movieMeasuredMovieHeight = SobotDensityUtil.dp2px(getContext(), movie.height());
            ...
            int[] screen = SobotDensityUtil.getScreenWH(getContext());
