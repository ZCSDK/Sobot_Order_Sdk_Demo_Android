...
public class SobotTimePickerView extends SobotBasePickerView implements View.OnClickListener {
    ...
    public static class Builder {
        private int layoutRes = R.layout.sobot_wo_pickerview_time;
        private SobotCustomListener customListener;
        ...
        public Builder setLayoutRes(int res, SobotCustomListener customListener) {
            this.layoutRes = res;
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            LayoutInflater.from(context).inflate(R.layout.sobot_wo_pickerview_time, contentContainer);
