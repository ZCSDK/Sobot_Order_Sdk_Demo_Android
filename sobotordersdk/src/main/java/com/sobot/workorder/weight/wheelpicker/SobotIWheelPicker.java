package com.sobot.workorder.weight.wheelpicker;
 ...
 * @version 1.1.0
 */
public interface SobotIWheelPicker {
     ...
     * 设置滚轮Item选中监听器
     *
     * @param listener 滚轮Item选中监听器{@link SobotWheelPicker.OnItemSelectedListener}
     */
    void setOnItemSelectedListener(SobotWheelPicker.OnItemSelectedListener listener);
     ...
     * {@link com.sobot.custom.widget.wheelpicker.WheelPicker.OnItemSelectedListener}回调监听或调用
     ...
     * through {@link com.sobot.custom.widget.wheelpicker.WheelPicker.OnItemSelectedListener} or call
     ...
     * 前所根据这些参数改变的一些属性，比如
     * {@link com.sobot.custom.widget.wheelpicker.WheelPicker.OnWheelChangeListener}和
     * {@link com.sobot.custom.widget.wheelpicker.WheelPicker.OnItemSelectedListener}监听器中方法参数的值，因
     * 此你总该在调用该方法后考虑到相关影响
     ...
     * {@link com.sobot.custom.widget.wheelpicker.WheelPicker.OnWheelChangeListener} and
     * {@link com.sobot.custom.widget.wheelpicker.WheelPicker.OnItemSelectedListener}, so you must always
     ...
     * @see com.sobot.custom.widget.wheelpicker.WheelPicker.OnWheelChangeListener
     */
    void setOnWheelChangeListener(SobotWheelPicker.OnWheelChangeListener listener);
    ...
    /**
     * 设置滚轮选择器数据项的对齐方式
     * 默认对齐方式为居中对齐{@link SobotWheelPicker#ALIGN_CENTER}
     * <p>
     * Set alignment of WheelPicker
     * The default alignment of WheelPicker is {@link SobotWheelPicker#ALIGN_CENTER}
     *
     * @param align 对齐方式标识值
     *              该值仅能是下列值之一：
     *              {@link SobotWheelPicker#ALIGN_CENTER}
     *              {@link SobotWheelPicker#ALIGN_LEFT}
     *              {@link SobotWheelPicker#ALIGN_RIGHT}
     */
