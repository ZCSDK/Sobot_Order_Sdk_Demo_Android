...
public class SobotWODetailHistoryFragment extends SobotWOBaseFragment {
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(getResLayoutId("sobot_fragment_wo_detail_history"), container, false);
        initView(root);
        return root;
    }

    public void initView(View view) {
        refreshLayout = view.findViewById(getResId("sobot_srl_workorder_history"));
        loading_layout = view.findViewById(getResId("sobot_loading_layout"));
        recyclerView = view.findViewById(getResId("sp_recyclerView"));
