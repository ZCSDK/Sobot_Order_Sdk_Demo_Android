...
public class SobotCategorySmallAdapter extends RecyclerView.Adapter {
    ...
    public SobotCategorySmallAdapter(Context context, List<SobotCusFieldDataInfoListModel> list, int fieldType) {
        super();
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder vh, final int position) {
        ...
        if (SobotConstantUtils.SOBOT_WO_CUSTOMER_FIELD_CHECKBOX_TYPE == fieldType) {
            ...
            if (modelResult.isChecked()) {
                myViewHolder.categorySmallCheckBox.setBackgroundResource(R.drawable.sobot_icon_category_small_checkbox_pressed);
            } else {
                myViewHolder.categorySmallCheckBox.setBackgroundResource(R.drawable.sobot_icon_category_small_checkbox_normal);
            }
        } else {
