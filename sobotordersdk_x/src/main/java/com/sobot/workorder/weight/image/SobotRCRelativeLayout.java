 ...
 * 作用：圆角相对布局
 */
public class SobotRCRelativeLayout extends RelativeLayout implements Checkable, SobotRCAttrs {
    SobotRCHelper mRCHelper;
    ...
    public void setOnCheckedChangeListener(SobotRCHelper.OnCheckedChangeListener listener) {
