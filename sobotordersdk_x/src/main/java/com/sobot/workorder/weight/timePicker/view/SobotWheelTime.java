...
import com.sobot.workorder.weight.timePicker.adapter.SobotNumericWheelAdapter;
import com.sobot.workorder.weight.timePicker.lib.SobotWheelView;
import com.sobot.workorder.weight.timePicker.listener.SobotOnItemSelectedListener;
...
public class SobotWheelTime {
    ...
    public void setPicker(int year, final int month, int day, int h, int m, int s) {
        ...
        currentYear = year;
        // 年
        wv_year = (SobotWheelView) view.findViewById(SobotResourceUtils.getIdByName(view.getContext(), "id", "year"));
        ...
        // 月
        wv_month = (SobotWheelView) view.findViewById(SobotResourceUtils.getIdByName(view.getContext(), "id", "month"));
        ...
        // 日
        wv_day = (SobotWheelView) view.findViewById(SobotResourceUtils.getIdByName(view.getContext(), "id", "day"));
        ...
        //时
        wv_hours = (SobotWheelView) view.findViewById(SobotResourceUtils.getIdByName(view.getContext(), "id", "hour"));
        wv_hours.setAdapter(new SobotNumericWheelAdapter(0, 23));
        /*  wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字*/
        wv_hours.setCurrentItem(h);
        wv_hours.setGravity(gravity);
        //分
        wv_mins = (SobotWheelView) view.findViewById(SobotResourceUtils.getIdByName(view.getContext(), "id", "min"));
        wv_mins.setAdapter(new SobotNumericWheelAdapter(0, 59));
        /* wv_mins.setLabel(context.getString(R.string.pickerview_minutes));// 添加文字*/
        wv_mins.setCurrentItem(m);
        wv_mins.setGravity(gravity);
        //秒
        wv_seconds = (SobotWheelView) view.findViewById(SobotResourceUtils.getIdByName(view.getContext(), "id", "second"));
