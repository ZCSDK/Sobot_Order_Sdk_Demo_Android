...
import com.sobot.workorder.activity.SobotWebViewActivity;

public class SobotURLSpan extends URLSpan {

    private Context context;
    private int color;
    private boolean isShowLine;// 下划线

    public SobotURLSpan(Context context, String url, int color) {
        this(context, url, color, false);
    }

    public SobotURLSpan(Context context, String url, int color, boolean isShowLine) {
        super(url);
