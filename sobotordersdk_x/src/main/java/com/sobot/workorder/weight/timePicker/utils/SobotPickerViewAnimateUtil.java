...
public class SobotPickerViewAnimateUtil {
    ...
    public static int getAnimationResource(Context context, int gravity, boolean isInAnimation) {
        switch (gravity) {
            case Gravity.BOTTOM:
                return isInAnimation ? SobotResourceUtils.getIdByName(context, "anim", "sobot_pickerview_slide_in_bottom") : SobotResourceUtils.getIdByName(context, "anim", "sobot_pickerview_slide_out_bottom");
        }
        return INVALID;
    }
}
