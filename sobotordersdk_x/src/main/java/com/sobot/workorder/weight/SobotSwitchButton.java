 ...
 * SobotSwitchButton.
 */
public class SobotSwitchButton extends View implements Checkable {
    ...
    public SobotSwitchButton(Context context) {
        super(context);
        init(context, null);
    }

    public SobotSwitchButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public SobotSwitchButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SobotSwitchButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(SobotSwitchButton view, boolean isChecked);
    }
