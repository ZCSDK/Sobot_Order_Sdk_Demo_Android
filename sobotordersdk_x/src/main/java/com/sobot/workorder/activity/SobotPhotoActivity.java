...
public class SobotPhotoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(SobotResourceUtils.getIdByName(this, "layout",
                "sobot_activity_wo_photo"));
        sobot_progress = (SoborRoundProgressBar) findViewById(SobotResourceUtils.getResId(this, "sobot_pic_progress_round"));
        ...
        mImageView = (SobotPhotoView) findViewById(SobotResourceUtils.getIdByName(this,
                "id", "sobot_order_big_photo"));
        sobot_image_view = (SobotGifView) findViewById(SobotResourceUtils.getIdByName(
