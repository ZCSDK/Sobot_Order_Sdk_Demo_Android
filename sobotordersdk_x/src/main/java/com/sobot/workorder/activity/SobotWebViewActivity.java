...
public class SobotWebViewActivity extends SobotBaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        sobot_btn_reconnect.setText(SobotResourceUtils.getResString(SobotWebViewActivity.this, "sobot_reunicon"));
        sobot_btn_reconnect.setOnClickListener(this);
        sobot_textReConnect = (TextView) findViewById(getResId("sobot_textReConnect"));
        sobot_textReConnect.setText(SobotResourceUtils.getResString(SobotWebViewActivity.this, "sobot_network_unavailable"));
